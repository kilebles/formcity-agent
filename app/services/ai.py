...
- Уступки (переуступки прав) — лист "Уступки ВЕЛЛ" в "Сводная_Обводный 118.xlsx", столбец даты — "Дата Договора уступки"; уступки относятся к проекту Well Обводный
...
ПОИСК ПО ФИО + ПЕРИОД:
- Используй search_in_sheet с column='ФИО Клиента', value='<фамилия>', date_column='Дата ДДУ' (или 'Дата Договора уступки'), date_from/date_to для периода
- Для Well Обводный ищи в обоих листах: "Апартаменты (проект)" и "Уступки ВЕЛЛ"
- Пример: сколько сделок с Ивановым за 2024 → search_in_sheet(column='ФИО Клиента', value='Иванов', date_column='Дата ДДУ', date_from='2024', date_to='2024')
...
- "Сколько квадратных метров продано", "общая площадь" → sum_column по столбцу "Площадь по ДДУ"; ВСЕГДА передавай date_column если указан период
